        ...
        <body>
            <table id="NAT" style="border: none;"> <!-- Scope of NAT document design -->
                <tr style="border: none;">
                    <td id="LMarg" style="border: none; width: 7%;"></td> <!-- document left margin -->
                    <td style="border: none;">
                        <table id="body" style="border: none;">
                            <tr id="page" style="border: none;"> <!-- page 1 -->
                                <td style="border: none;"> 
                                    <table id="body" style="width: 100%; border: none;">
                                        <tr id="phead" style="border: none;">
                                            <td style="border: none;"> <!-- page 1 header -->
                                                <table style="width: 100%; border: none;"> <!-- page 1 header -->
                                                    <tr style="border: none;">
                                                        <td rowspan="2" style="width:200px; border: none; border-bottom: 1px solid black;">
                                                            <img 
                                                                class="img"
                                                    ...
                                                    <tr style="border-right: none; border-bottom: 1px solid black;">
                                                        <td style="text-align: right; border: none; border-right: none;">Page 1 of 2</td>
                                                    </tr>
                                                </table>
                                            </td> 
                                        </tr>
                                        <tr id="pbody" style="border: none;">
                                            <td style="border: none;"> <!-- page 1 content -->
                                                ...
                                                <p>
                                                    Dear
                                                    <br>
                                                    We are notifying you that an individual who tested negative on a previous donation has recently tested positive for the
                                                    viral marker designated below. The FDA requires Blood Centers to notify consignees of the products from any prior
                                                    donations for the purpose of recipient tracing. Gulf Coast Regional Blood Center will provide testing for the recipient if
                                                    an indicated component on the enclosed report was transfused at your facility. Any test results will be mailed directly to
                                                    the recipient's physician and the Medical Director/Designee at your facility. Please complete the attached report for our
                                                    records even if testing will not be requested on the recipient.
                                                ...
                                                <p>
                                                    You are welcome to contact a Technical Services representative at 713-791-6606 if you have any questions 
                                                    <br>
                                                    Sincerely, 
                                                </p>
                                                ...
                                                <p>
                                                    Person's Title
                                                    <br>
                                                    Enclosure(s) A copy of this letter was faxed or mailed on
                            ...
                            <tr id="page2" style="border: none;"> <!-- page 2 -->
                                <td style="border: none;">
                                    <table id="body" style="width: 100%; border: none;">
                                        <tr id="phead" style="border: none;">
                                            <td style="border: none;"> <!-- page 2 header -->
                                                <table style="width: 100%; border: none;"> <!-- page 2 header -->
                                                    <tr style="border: none;">
                                                        <td rowspan="2" style="width:200px; border: none; border-bottom: 1px solid black;">
                                                            <img 
                                                                class="img"
                                                    ...
                                                    <tr style="border-right: none; border-bottom: 1px solid black;">
                                                        <td style="text-align: right; border: none; border-right: none;">Page 2 of 2</td>
                                                    </tr>
                                                </table>
                                            </td> 
                                        </tr>
                                        <tr id="pbody" style="border: none;">
                                            <td style="border: none;"> <!-- page 2 content -->
                                                ...
                                                <ul>
                                                    <li>Collect blood samples in two (2) 7mL EDTA anticoagulant tubes</li>
                                                    <li>Label the samples with: a unique recipient ID number or code (do not use the patient's name), name of the recipient's
                                                    physician and date the sample is collected.</li>
                                                    <li>Send the coded blood sample <b>and</b> the completed <i><u>Lookback Notification Recipient Status Report</u></i> to Gulf Coast Regional
                                                    Blood Center, "National Donor Testing Services" Laboratory, attention: Donor Services.</li>
                                                    <li>Please contact a Donor Services representative at 713-791-6606 to alert them that you are sending a recipient sample for
                                                    testing.</li>
                                                    <li><b>Note: samples submitted without this form <u>can not be tested</u></b></li>
                                                </ul>
                                                <table style="width: 100%;">
                                                    <tr >
                                                    ...
                                                    <tr>
                                                        <td>&nbsp;<input type="checkbox" />&nbsp;Unit Discarded</td>
                                                        <td>&nbsp;<input type="checkbox" />&nbsp;Unit Expired</td>
                                                        <td colspan="3">&nbsp;<input type="checkbox" />&nbsp;Used for Further Manufacturing </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3">&nbsp;<input type="checkbox" />&nbsp;Unit Returned to Gulf Coast Regional Blood Center</td>
                                                        <td colspan="2">&nbsp;Date:</td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3">&nbsp;<input type="checkbox" />&nbsp;Unit Transfused <b>(Please Complete Recipient Information)</b></td>
                                                        <td colspan="2">&nbsp;Date:</td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5" style="background-color: #999999; text-align: center;">
                                                    ...
                                                    <tr>
                                                        <td colspan="2">&nbsp;<input type="checkbox" />&nbsp;Recipient information is not available</td>
                                                        <td colspan="3">&nbsp;<input type="checkbox" />&nbsp;Recipient testing not desired at this time</td>
                                                    </tr>
                                                    <tr>
                                                        <td rowspan="3">&nbsp;Recipient Status: </td>
                                                        <td>&nbsp;<input type="checkbox" />&nbsp;Alive</td>
                                                        <td colspan="3">&nbsp;Has recipient been notified?   <input type="checkbox" />&nbsp;No     <input type="checkbox" />&nbsp;Yes   Date:  </td>
                                                    </tr>
                                                    <tr>
                                                        <td >&nbsp;<input type="checkbox" />&nbsp;Deceased</td>
                                                        <td colspan="3">Date:     </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5">&nbsp;<input type="checkbox" />&nbsp;Unknown</td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5" style="background-color: #999999; text-align: center;">
                                                    ...
                                                    <tr>
                                                        <td colspan="3">&nbsp;Attending Physician's Name:</td>
                                                        <td colspan="2">&nbsp;Phone#:</td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5">&nbsp;Transfusion Service Medical Director's Name:</td>
                                                    </tr>
                                                    <tr>
      ...
      <div>
        ...
        >
            <section slot="pdf-content">
                <body>
                    <table id="NAT" style="border: none; max-height: 1000px;"> <!-- Scope of NAT document design -->
                        <tr style="border: none; ">
                            <td id="LMarg" style="border: none; width: 7%;"></td> <!-- document left margin -->
                            <td style="border: none;">
                                <table id="body" style=" border: none;">
                                                ...
                                                <tr id="phead" style="border: none;">
                                                    <td style="border: none;"> <!-- page 1 header -->
                                                        <table style="width: 100%; border: none;"> <!-- page 1 header -->
                                                            ...
                                                            <tr style="border-right: none; border-left: none; border-top: none; border-bottom: 1px solid black;">
                                                                <td style="text-align: right; border: none; border-right: none;">Page 1 of 2</td>
                                                            </tr>
                                                        </table>
                                                    </td> 
